...
class PdfService {
  // --------------------------------------------------------------
  // 🧪 1. AI CHECKUP REPORT (Your original function)
  // --------------------------------------------------------------
  static Future<void> generateCheckupReport({
    ...
    final footerNote = isHindi
        ? 'आपल्या आरोग्याची काळजी घ्या — आपला डिजिटल आरोग्य सहाय्यक, आयूट्रॅक'
        : isMarathi
            ? 'आपल्या आरोग्याची काळजी घ्या — आपला डिजिटल आरोग्य सहकारी, आयूट्रॅक'
            : 'Take care of your health — Your Digital Health Partner, AayuTrack';
  ...
  // --------------------------------------------------------------
  // 📝 2. DASHBOARD DAILY REPORT (NEW FUNCTION YOU NEED)
  // --------------------------------------------------------------
      ...
      pw.Page(
        ...
        build: (context) => pw.Column(
          ...
          children: [
            ...
            pw.Divider(),
            pw.Center(
              child: pw.Text("AayuTrack — Stay Consistent, Stay Healthy",
                  style: pw.TextStyle(
